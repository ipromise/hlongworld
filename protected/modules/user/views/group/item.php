...
<div class="main">
    <div class="spaceTop pr" style="background:url('<?php echo isset($group['background']) ? SITE_URL.GlobalF::separator_r2l($group['background']) : '';?>') no-repeat">
    	...
    	<div class="setName">
            <div>
                <span class="spaceName"><?php echo isset($group['name']) ? $group['name'] : '';?></span>
                <!--<span class="spaceLV">123</span>-->
                <p class="setButton"></p>
            </div>
            <div class="mt10">我们的口号是：<?php echo isset($group['slogan']) ? $group['slogan'] : '';?></div>
        </div>
        <div class="spaceTF">
        	<ul class="fl">
            ...
            <ul class="fr">
                <li><a href="http://www.lamabang.com/user-me">+ 加入</a></li>
                <li><a href="http://www.lamabang.com/user-me">发帖</a></li>
            </ul>
            <div class="cb"></div>
        </div>
    </div>
	...
	<ul class="ml5">
            <?php if(isset($pendragon)){?>
            <?php foreach($pendragon as $val){?>
            <li>
                <a href="">
                    <img src="<?php echo $headman['head'];?>">
                </a>
                <p>
                    <a href=""><?php echo $headman['name'];?></a>
                </p>
            </li>
            <?php }?>
            <?php }?>
    ...
    <div class="cLeft">
            <div class="myTrends">
            	<div class="h40">
                    <ul class="fl">
                    	<li class="selectFaction"><a href="http://www.lamabang.com/user-space/u-6A4D4C17686344136973761A-t-topic.html">全部</a></li>
